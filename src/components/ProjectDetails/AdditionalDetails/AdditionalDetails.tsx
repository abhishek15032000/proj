...
const details = [
  { heading: 'PROJECT TYPE', value: 'Agriculture Forestry & Other Land Use' },
  {
    heading: 'REFERENCE & APPLIED METHODOLOGY',
    value: ['Methodology 1 Name', 'Methodology 2 Name'],
  },
  { heading: 'PROJECT START DATE', value: 'DDMMYYYY' },
  { heading: 'PROJECT END DATE', value: 'DDMMYYYY' },
  { heading: 'CREDITING PERIOD', value: ['Start: DDMMYYYY', 'End: DDMMYYYY'] },
]
const cardDetails = [
