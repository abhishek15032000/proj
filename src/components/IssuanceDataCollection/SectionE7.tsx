...
const SectionE7 = () => {
  ...
  return (
    <Grid container flexDirection="column" xs={12} height={'100vh'}>
      ...
      >
        Actual emission reductions or net anthropogenic GHG removals during 1st
        commitment period
      </Typography>
      <TextareaAutosize
      ...
      />
      <SampleModal
        mediaArray={[require('../../assets/Images/SectionE7.png')]}
        stringArray={[
          'Sample Report - Actual emission reductions or net anthropogenic GHG removals during 1st commitment period',
        ]}
