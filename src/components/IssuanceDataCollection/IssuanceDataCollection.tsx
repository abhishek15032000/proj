...
//  const sectionA = store.getState()?.sectionA
//  console.log('modal_Ref: ', modalRef)
//  const loading = useAppSelector(
//    ({ newProject }) => newProject.loading,
//    shallowEqual
//  )
...
//  )
//  const A3 = useAppSelector(({ sectionA }) => sectionA.A3)
//  const A4 = useAppSelector(({ sectionA }) => sectionA.methodologies)
//  const A5 = useAppSelector(({ sectionA }) => sectionA.A5)
//  const A6 = useAppSelector(({ sectionA }) => sectionA.A6)
//  const A7 = useAppSelector(({ sectionA }) => sectionA.A7)
//  const B1 = useAppSelector(({ sectionB }) => sectionB.B1)
...
//  useEffect(() => {
//    if (isApiCallSuccess) {
//      //sectionIndex === 5 && sectionIndexState !== 4 && changeInSection && delay_code(1000)
//      //console.log('finish')
//      handleSectionIndexFromModal()
//    }
//  }, [isApiCallSuccess])
...
//  const handleNextBtnFromSectionE = () => {
//    console.log('op_handleNextBtnFromSectionE')
//    if (nextBtn) {
//      navigate(pathNames.DASHBOARD)
//    } else if (!nextBtn) {
//      if (
...
//            return {
//              sectionName: String.fromCharCode(65 + index) + (stepIndex + 1),
//              subSectionRow: cur[item],
//              section: index + 1,
//              subSection: parseInt(item.charAt(item.length - 1)) - 1,
//            }
//          })
//        //const tempArr:any = Object.keys(cur).reduce((subStepAcc:any, subStepCur:any, subStepIndex:any) => {
//        //  const tempObj : any = []
//        //  if(typeof cur[subStepCur] === 'object' && !Array.isArray(cur[subStepCur])){
//        //    //console.log('subStepCur:', cur)
//        //    //acc['sectionName'] = `${'section_a'.charAt(cur.length - 1).toUpperCase()}`
//        //    //tempObj = {
//        //    //       'sectionName' : index,
//        //    //'subSectionRow' : cur[subStepCur],
//        //    //'section' : index + 1,
//        //    //'subSection' : subStepCur.charAt(subStepCur.length - 1),
//        //    //}
//        //    subStepAcc['sectionName'] = 'A'
//        //    subStepAcc['subSectionRow'] = cur[subStepCur]
//        //    subStepAcc['section'] = index + 1
//        //    subStepAcc['subSection'] = subStepCur.charAt(subStepCur.length - 1)
//        //  }
//        //  console.log('subStepAcc:', subStepAcc)
//        //  tempObj[tempObj.length] = subStepAcc
...
//      changeInSection,
//      sectionIndexState,
//      subSectionIndexState
//    )

//    dispatch(setSubSectionIndex(subSectionIndexState))
//    //ChangeInSection is to know whether the issuer has clicked on section level next or he clicked on subSection level
//    if (sectionIndex !== 5 && changeInSection) {
//      dispatch(setSectionIndex(sectionIndexState))
//      setChangeInSection(false)
//    }
//    dispatch(setIsApiCallSuccess(false))
//    if (sectionIndex === 5 && sectionIndexState !== 4 && changeInSection) {
//      console.log('entering into return')
//      handleNextBtnFromSectionE()
//      dispatch(setSubSectionIndex(subSectionIndexState))
//      dispatch(setIsApiCallSuccess(false))
//      //return
